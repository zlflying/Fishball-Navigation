...
const searchNodes: SearchNode[] = [
    {
        sourceCode: "bing",
        sourceName: "必应",
        iconPath: "./img/search/bing.png",
        baseUrl: "https://www.bing.com/search?q="
    },
    {
        sourceCode: "wanfang",
        sourceName: "万方",
        iconPath: "./img/search/wanfang.png",
        baseUrl: "https://s.wanfangdata.com.cn/paper?q="
    },
    {
        sourceCode: "baidu",
        sourceName: "百度学术",
        iconPath: "./img/search/baidu.png",
        baseUrl: "https://xueshu.baidu.com/s?wd="
    },
    {
        sourceCode: "pubmed",
        sourceName: "PubMed",
        iconPath: "./img/search/pubmed.png",
        baseUrl: "https://pubmed.ncbi.nlm.nih.gov/?term="
    },
    {
        sourceCode: "github",
        sourceName: "GitHub",
        iconPath: "./img/search/github.png",
        baseUrl: "https://github.com/search?q="
    },
    {
        sourceCode: "translator",
        sourceName: "在线翻译",
        iconPath: "./img/search/translator.png",
