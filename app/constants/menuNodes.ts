...
export const commonMenuNodes: MenuNode[] = [
    {
        ...
        items: [{
            ...
            logoPath: "./img/menu/中国知网（CNKI）.png",
            ...
            logoPath: "./img/menu/国家科技图书文献中心（NSTL）.png",
            ...
            logoPath: "./img/menu/WebofScience.png",
            ...
            logoPath: "./img/menu/NoteExpress.png",
            ...
            logoPath: "./img/menu/ScienceDirect.png",
        ...
        children: [{
            ...
            items: [{
                ...
                logoPath: "./img/menu/中文社会科学引文索引（CSSCI）.png",
            ...
            items: [{
                ...
                logoPath: "./img/menu/国家哲学社会科学文献中心(NSSD).png",
                ...
                logoPath: "./img/menu/中国心理科学信息中心.png",
            ...
            items: [{
                ...
                logoPath: "./img/menu/SemanticScholar.png",
        ...
        children: [{
            ...
            items: [{
                ...
                logoPath: "./img/menu/ProQuest.png",
                ...
                logoPath: "./img/menu/SageResearchMethods.png",
            ...
            items: [{
                ...
                logoPath: "./img/menu/ProjectMUSE.png",
            ...
            items: [{
                ...
                logoPath: "./img/menu/WileyOnlineLibrary.png",
                ...
                logoPath: "./img/menu/CambridgeJournalsOnline.png",
            ...
            items: [{
                ...
                logoPath: "./img/menu/IEEEXplore.png",
                ...
                logoPath: "./img/menu/ASMEDigitalLibrary.png",
                ...
                logoPath: "./img/menu/MaterialsScience&EngineeringDatabase.png",
                ...
                logoPath: "./img/menu/ACMDigitalLibrary.png",
                ...
                logoPath: "./img/menu/EngineeringVillage.png",
                ...
                logoPath: "./img/menu/ASCELibrary.png",
                ...
                logoPath: "./img/menu/CiteseerX.png",
                ...
                logoPath: "./img/menu/MaterialsProjectDocumentation.png",
                ...
                logoPath: "./img/menu/ICEVirtualLibrary.png",
            ...
            items: [{
                ...
                logoPath: "./img/menu/PubMedCentral(PMC).png",
                ...
                logoPath: "./img/menu/Elsevier.png",
                websiteUrl: "https://www.sciencedirect.com/",
                redirectType: "DETAIL"
            }, {
        ...
        children: [{
            ...
            items: [{
                ...
                logoPath: "./img/menu/GooglePatents.png",
        ...
        children: [{
            ...
            items: [{
                ...
                logoPath: "./img/menu/EI《工程索引》/TheEngineeringIndex.png",
                ...
                logoPath: "./img/menu/SSCI《社会科学引文索引》/SocialSciencesCitationIndex.png",
                websiteUrl: "https://clarivate.com/webofsciencegroup/",
                redirectType: "DETAIL"
            }, {
                ...
                logoPath: "./img/menu/ISTP《科技会议录索引》/IndextoScientific&TechnicalProceedings.png",
                websiteUrl: "https://clarivate.com/webofsciencegroup/",
                redirectType: "DETAIL"
            }]
        }, {
            ...
            items: [{
                ...
                description: "南京大学",
                logoPath: "./img/menu/中文社会科学索引（CSSCI）来源期刊.png",
                ...
                logoPath: "./img/menu/中国科技论文统计源期刊/中国科技核心期刊.png",
        ...
        items: [{
            ...
            logoPath: "./img/menu/Mendeley.png",
        ...
        children: [{
            ...
            items: [{
                ...
                logoPath: "./img/menu/iThenticate.png",
                ...
                logoPath: "./img/menu/CrossCheck.png",
        ...
        items: [{
            ...
            logoPath: "./img/menu/ChatExcel.png",
            ...
            logoPath: "./img/menu/Image-Pro.png",
        ...
        items: [{
            ...
            logoPath: "./img/menu/AdobeIllustrator.png",
            ...
            logoPath: "./img/menu/Inkscape.png",
            ...
            logoPath: "./img/menu/MindtheGraph.png",
            ...
            logoPath: "./img/menu/BioRender.png",
            ...
            logoPath: "./img/menu/ChemDraw.png",
        ...
        items: [{
            ...
            description: "社科类项目查询",
            logoPath: "./img/menu/国家社科基金项目数据库.png",
            ...
            logoPath: "./img/menu/MedSci（梅斯医学）“全球基金查询”.png",
            ...
            logoPath: "./img/menu/ZCOOL国家自然科学基金查询.png",
        ...
        items: [{
            ...
            logoPath: "./img/menu/ResearchGate.png",
            ...
            logoPath: "./img/menu/LinkedIn.png",
            ...
            logoPath: "./img/menu/Academia.png",
            ...
            logoPath: "./img/menu/LabRoots.png",
        ...
        items: [{
            ...
            logoPath: "./img/menu/ChemRxiv.png",
            ...
            logoPath: "./img/menu/Preprints.org.png",
        ...
        children: [{
            ...
            items: [{
                ...
                logoPath: "./img/menu/Sourcetrail.png",
                ...
                logoPath: "./img/menu/ScitoolsUnderstand.png",
                ...
                logoPath: "./img/menu/SourceInsight.png",
            ...
            items: [{
                ...
                logoPath: "./img/menu/TraceIDE.png",
                ...
                logoPath: "./img/menu/AmazonCodeWhisperer.png",
                ...
                logoPath: "./img/menu/GitHubCopilot.png",
...
export const computerMenuNodes: MenuNode[] = [
    {
        ...
        items: [{
            ...
            logoPath: "./img/menu/TensorFlow.png",
        ...
        children: [{
            ...
            items: [{
                ...
                logoPath: "./img/menu/w3schools.png",
                ...
                description: "代码编译器",
                logoPath: "./img/menu/VisualStudioCode.png",
                ...
                description: "开源Web应用",
                logoPath: "./img/menu/JupyterNotebook.png",
            ...
            items: [{
                ...
                logoPath: "./img/menu/DeveloperRoadmaps.png",
                ...
                description: "源代码托管网站",
                logoPath: "./img/menu/Bitbucket.png",
                ...
                logoPath: "./img/menu/3Blue1Brown.png",
        ...
        children: [{
            ...
            items: [{
                ...
                logoPath: "./img/menu/RayRLLib.png",
            ...
            items: [{
                ...
                logoPath: "./img/menu/AWSAI&ML.png",
                ...
                logoPath: "./img/menu/MicrosoftAzureAI.png",
                ...
                logoPath: "./img/menu/LightGBM.png",
        ...
        children: [{
            ...
            items: [{
                ...
                logoPath: "./img/menu/ZetaneViewer.png",
                ...
                logoPath: "./img/menu/ZetaneInsightEngine.png",
                ...
                logoPath: "./img/menu/pyCirclize.png",
                ...
                description: "科研绘图",
                logoPath: "./img/menu/PythonGraphGallery.png",
                ...
                logoPath: "./img/menu/Matplotlib.png",
                ...
                logoPath: "./img/menu/PowerPoint(PPT).png",
            ...
            items: [{
                ...
                logoPath: "./img/menu/TensorFlowPlayground.png",
                ...
                logoPath: "./img/menu/AIbyHand.png",
                ...
                description: "算法可视化网站",
                logoPath: "./img/menu/AlgorithmVisualizer.png",
                ...
                logoPath: "./img/menu/OneSmallStep.png",
                ...
                logoPath: "./img/menu/TransformerExplainer.png",
                ...
                logoPath: "./img/menu/100DaysofMLCode.png",
                ...
                description: "全自动调参工具",
                logoPath: "./img/menu/WandbWeave.png",
                ...
                logoPath: "./img/menu/TensorBoard.png",
        ...
        children: [{
            ...
            items: [{
                ...
                logoPath: "./img/menu/MicrosoftResearchOpenData.png",
                ...
                logoPath: "./img/menu/StanfordLargeScaleDataSets.png",
                ...
                logoPath: "./img/menu/OpenAIDatasets.png",
                ...
                description: "数据集网站",
                logoPath: "./img/menu/BrowseState-of-the-Art.png",
                ...
                logoPath: "./img/menu/UCIMachineLearningRepository.png",
                ...
                logoPath: "./img/menu/ChinaXiv.png",
        ...
        children: [{
            ...
            displayName: "知识图谱",
            nodeType: "MENU",
            iconPath: "./img/menu/知识图谱.png",
            children: [],
            items: [{
                itemId: "1b4c033d-f19d-48bd-b05b-29016152e1d5",
                displayName: "Neo4j",
                description: "一种图数据库",
                logoPath: "./img/menu/Neo4j.png",
                ...
                description: "开源图数据库",
                logoPath: "./img/menu/Blazegraph.png",
                ...
                logoPath: "./img/menu/PyTorchGeometric.png",
                ...
                logoPath: "./img/menu/DGL(DeepGraphLibrary).png",
                ...
                logoPath: "./img/menu/Spektral.png",
            ...
            items: [{
                ...
                description: "图神经网络算法",
                logoPath: "./img/menu/GraphSAGE.png",
            ...
            items: [{
                ...
                logoPath: "./img/menu/Statsmodels.png",
            ...
            items: [{
                ...
                logoPath: "./img/menu/FasterR-CNN.png",
                ...
                logoPath: "./img/menu/MaskR-CNN.png",
            ...
            items: [{
                ...
                logoPath: "./img/menu/IBMWatson.png",
                ...
                logoPath: "./img/menu/Transformers.png",
            ...
            items: [{
                ...
                logoPath: "./img/menu/3DSlicer.png",
        ...
        children: [{
            ...
            items: [{
                ...
                logoPath: "./img/menu/NeuralNetworks.png",
                ...
                logoPath: "./img/menu/JournalofMachineLearningResearch.png",
        ...
        children: [{
            ...
            items: [{
                ...
                logoPath: "./img/menu/DeepSpeed.png",
            ...
            items: [{
                ...
                logoPath: "./img/menu/AdversarialRobustnessToolbox.png",
                ...
                logoPath: "./img/menu/CleverHans.png",
